...
```bash
python3 .Codex/skills/skill-deployer/scripts/sync.py --list
```
...
# 多个 agent
python3 .Codex/skills/skill-deployer/scripts/sync.py --agent hermes workbuddy
...
脚本路径：`.Codex/skills/skill-deployer/scripts/sync.py`

### 输入

1. `.Codex/skills/skill-deployer/scripts/deploy.json` — agents 配置
