...
# dependencies = []
# ///
"""将旧格式文章（assist/article.py 产出）迁移为 gen-knowledge-curator 标准格式。

用法:
  uv run custom-skills/general/gen-knowledge-curator/scripts/km_migrate_articles.py <目录>
  uv run custom-skills/general/gen-knowledge-curator/scripts/km_migrate_articles.py ~/.knowledge/ai-engineering
"""
