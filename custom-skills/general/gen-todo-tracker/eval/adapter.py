"""gen-todo-tracker environment adapter for ReflACT."""
...
from .dataloader import GenTodoTrackerDataLoader
from .rollout import run_batch


class GenTodoTrackerAdapter(EnvAdapter):
    """GenTodoTracker environment adapter."""
    ...
    def __init__(
        ...
        self.dataloader = GenTodoTrackerDataLoader(
            split_dir=split_dir,
            data_path=data_path,
    ...
    def rollout(self, env_manager, skill_content: str, out_dir: str, **kwargs) -> list[dict]:
        ...
        if system_prompt_template is None:
            system_prompt_template = load_prompt("rollout_system", env="gen-todo-tracker")
        return run_batch(
            items=items,
            out_root=out_dir,
