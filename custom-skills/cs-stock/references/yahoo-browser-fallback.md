...
```bash
# 抓取股票页面 → Markdown
uv run custom-skills/cs-crawl/scripts/pwright_scrape.py scrape "https://finance.yahoo.com/quote/AAPL/"

# 抓取纯文本（更快）
uv run custom-skills/cs-crawl/scripts/pwright_scrape.py text "https://finance.yahoo.com/quote/AAPL/"
```
