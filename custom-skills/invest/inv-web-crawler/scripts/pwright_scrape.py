...
用法:
  uv run custom-skills/inv-web-crawler/scripts/pwright_scrape.py scrape <url>
  uv run custom-skills/inv-web-crawler/scripts/pwright_scrape.py scrape <url> --selector article
  uv run custom-skills/inv-web-crawler/scripts/pwright_scrape.py scrape <url> --wait 5000
  uv run custom-skills/inv-web-crawler/scripts/pwright_scrape.py text <url>
"""
